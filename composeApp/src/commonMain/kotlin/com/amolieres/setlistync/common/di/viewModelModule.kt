...
val viewModelModule = module {
    ...
    viewModel { GigDetailViewModel(get(), get(), get(), get(), get(), get()) } // SavedStateHandle, GetGigUseCase, CreateGigUseCase, UpdateGigUseCase, ObserveSongsUseCase, ObserveNotationUseCase
}
